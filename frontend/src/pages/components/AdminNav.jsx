          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                <Icon
                  size={18}
                  className={`${isActive ? "text-blue-600" : "text-slate-400 group-hover:text-blue-500"} transition-colors`}
                />
                <span
      ...
      <div className="p-4 mt-auto">
        <div className="bg-slate-50 rounded-[1.5rem] p-5 mb-4 border border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white font-black text-sm shadow-lg shadow-blue-100">
              AD
            </div>
